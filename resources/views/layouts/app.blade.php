...
<head>
    ...
    <style>
        ...
        .bento-card { background: rgba(30, 41, 59, 0.4); border: 1px solid rgba(255, 255, 255, 0.08); transition: all 0.3s ease; }
        .bento-card:hover { border-color: rgba(59, 130, 246, 0.5); background: rgba(30, 41, 59, 0.6); }
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <header class="h-20 flex items-center justify-between px-8 border-b border-white/5 sticky top-0 bg-slate-950/50 backdrop-blur-md z-40">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-sm font-bold text-slate-400 uppercase tracking-[0.2em]">Logistics System</h2>
